resource "aws_instance" "site_dev"{
  ami = var.ami_aws #para o auto-scalling coloca-se a AMI template criada para isso.
...
resource "aws_s3_bucket" "ti_saude_s3" {
...
#criação de Security Group para barrar Acesso exter à ec2 do site
